defmodule EctoPaginator do
  ...
  `EctoPaginator` can take any options accepted by `paginate/3`. This is useful when
  ...
  the pagination function you can define your own function like so:
      ...
      defmodule MyApp.Repo do
        ...
        def my_paginate_function(queryable, opts \\ [], repo_opts \\ []) do
          ...
          EctoPaginator.paginate(queryable, opts, __MODULE__, repo_opts)
        end
      end
  """
  ...
  alias EctoPaginator.{Config, Cursor, Ecto.Query, Page, Page.Metadata}
  ...
  ## Options
    ...
    * `:fetch_cursor_value_fun` function of arity 2 to lookup cursor values on returned records.
    Defaults to `EctoPaginator.default_fetch_cursor_value/2`
  ...
  To build the cursor EctoPaginator uses the returned Ecto.Schema. When using a joined
  ...
  ## Example
      ...
      Repo.paginate(query,
        ...
        fetch_cursor_value_fun: fn
          ...
          post, field ->
            EctoPaginator.default_fetch_cursor_value(post, field)
        end,
        limit: 50
      )
  ...
  ### Example
      ...
      iex> EctoPaginator.cursor_for_record(%EctoPaginator.Customer{id: 1}, [:id])
      "O//J5sUwG5gsGvsW2SQ3/zo6OoNoAm0AAAAFk6gg9VNtAAAAEMmNXIaUVZorw99ASczKvzo="

      iex> EctoPaginator.cursor_for_record(%EctoPaginator.Customer{id: 1, name: "Alice"}, [id: :asc, name: :desc])
      "O//J5sUwG5gsGvsW2SQ3/zo6OoNoAm0AAAATk68g9FL7vqyqLDiMRee0axIgcW0AAAAQQke8OWwmJiafAsJlEIM9Wg=="
  """
  @spec cursor_for_record(any(), [atom], (map(), atom() | {atom(), atom()} -> any())) :: binary()
  def cursor_for_record(
        record,
        cursor_fields,
        fetch_cursor_value_fun \\ &EctoPaginator.default_fetch_cursor_value/2
      ) do
  ...
  map. This function can be overriden in the `EctoPaginator.Config` using the
  ...
  ### Example
      ...
      iex> EctoPaginator.default_fetch_cursor_value(%EctoPaginator.Customer{id: 1}, :id)
      1

      iex> EctoPaginator.default_fetch_cursor_value(%EctoPaginator.Customer{id: 1, address: %EctoPaginator.Address{city: "London"}}, {:address, :city})
      "London"
  """
